...
берем первый id_mk                              405
    ...
    тестить уровень крафта можно например на     кбп
    Recipe: Tome of Blood на 2ом уровне - запускаем первым
    Recipe: Heavens Divider (60%) есть на 3 и на 4 уровне - запускаем вторым, кбп должен подвинутся со 2 уровня на 3, а потом и на 4


      "requested":
      ещё передаем айди итема



      куда копать - для ПЛ сета тратится неебенное количество стали, хотя там нужна фигня, 
      сталь идёт на корды, кордов мало и крафтятся по 20 шт сразу
      и по старому принципу - если накрафтили с перебором - остаток "положили" в инв
      ...
      покопать сортировку на предмет
      рецепт
      затем куски
      потом ресы\
      потом кри+гемы
